...
function inici() {
  document
    .getElementById("carregar")
    .addEventListener("click", obtenirProductes);
  document.getElementById("afegir").addEventListener("click", afegirProducte);
  document
    .getElementById("modificar")
    .addEventListener("click", modificarProducte);
  document
    .getElementById("esborrar")
    .addEventListener("click", esborrarProducte);
...
function afegirProducte() {
  ...
  xhr.open("POST", "http://localhost:8888/api/productes");
...
function modificarProducte() {
  ...
  xhr.open("PUT", `http://localhost:8888/api/productes/${cat}/${nom}`);
  xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
  xhr.send(data);
}
...
function esborrarProducte() {
  ...
  xhr.open("DELETE", `http://localhost:8888/api/productes/${cat}/${nom}`);
  xhr.send(null);
}
