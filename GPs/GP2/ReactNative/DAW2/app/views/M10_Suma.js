      ...
      <SafeAreaView>
        <TextInput
          ...
          onChangeText={(nombre1) => {
            ...
            this.forceUpdate();
            this.resultat =
              parseInt(this.state.nombre1) + parseInt(this.state.nombre2);
        ...
        <Button
          title="Suma"
          onPress={() => {
            Alert.alert("Resultat", this.resultat.toString(), [
              {
                text: "Cancel",
        ...
        <Text>
          el Resultat de {this.state.nombre1} + {this.state.nombre2} és{" "}
          {this.resultat}
        </Text>
      </SafeAreaView>
    );
