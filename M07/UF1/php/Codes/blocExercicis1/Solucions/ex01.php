		...
		foreach ($llista_param as $param) {
			switch ($param) {
				case "SERVER_SOFTWARE":
					echo "Versió del servidor Apache2: " . $_SERVER[$param] . "<br>";
					break;
				case "SERVER_PROTOCOL":
					echo "Versió HTTP del servidor: " . $_SERVER[$param] . "<br>";
					break;
				case "SERVER_PORT":
					echo "Port del servidor: " . $_SERVER[$param] . "<br>";
					break;
				case "PHP":
					echo "Versió de PHP: " . phpversion() . "<br>";
					break;
			}
		}
	}
