<?php
	...
	# Consultes	
	$nom="sergi";
	$emaildom="net$"; //Expressió regular. Cadena que finalitza amb net
	$cognoms="^po"; //Expressió regular. Cadena o número que comença amb po
	$consulta = "select * from $taula where nom = '$nom';";
	$consulta .= "select * from $taula where email regexp '$emaildom';"; //Important el punt davant l'igual per concatenar cadenes
	$consulta .= "select * from $taula where cognoms regexp '$cognoms';";//Important el punt davant l'igual per concatenar cadenes
