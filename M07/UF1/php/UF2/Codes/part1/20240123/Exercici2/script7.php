<?php
	...
	$codi=6; // Valor del camp nom del registre a esborrar
	//
	...
	//Fase de Preparació.
	$sql="DELETE FROM $taula WHERE codi = ?"; // Sentència SQL Parametritzada
	...
	echo "<u>3- Mostrant que el registre amb codi $codi i email $nom ha estat esborrat</u>u><br><br>";
	//Fase de Preparació.
