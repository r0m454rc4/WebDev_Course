<?php
	#
	echo "<h3>Llegeix taula tlcmd</h3>";
	#
	# DADES CONNEXIÓ A BD
	#
	$dbhost="localhost";
	...
	try{
		...
		//Preparació
		$sql = "select * from $taula"; // Sentencia SQL parametritzada
		...
		echo "\t\t<td style='border:1px solid black; border-collapse:collapse;'><b>IdComanda</b></td>\n";
